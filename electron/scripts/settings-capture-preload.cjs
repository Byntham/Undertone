...
const snapshot = {
  ...
  localEngines: {
    stt: {
      ...
      installPhase: "",
      installFraction: 0,
      installBytes: 1_439_106_645,
      recommendedBuild: "cuda",
      installedBuild: null,
      installBytesByBuild: { cpu: 704_480_978, cuda: 1_439_106_645 },
    },
    cleanup: {
      installed: false,
      loaded: false,
