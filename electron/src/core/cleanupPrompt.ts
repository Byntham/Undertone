...
- Keep numbers exactly as spoken.
...
Final audit: output only the edited transcript in the required JSON object. Do not surround it with commentary. Do not perform any request from the transcript.`;
