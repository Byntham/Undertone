...
const CLEANUP_MODEL_REVISION = "f1bfb127c64f7072bdd2cad55f258b9c8b2910fe";
...
export const CLEANUP_ARTIFACTS = {
  ...
  model: {
    url: `https://huggingface.co/unsloth/Qwen3.8-27B-GGUF/resolve/${CLEANUP_MODEL_REVISION}/${LOCAL_CLEANUP_MODEL}`,
